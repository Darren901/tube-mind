...
- **客製化偏好 (New!)**: 支援使用者自訂摘要的語氣（專業、輕鬆、簡潔等）、詳細程度以及語音導讀的性別。
...
- **API 測試**: 24/24 有效端點已全數通過測試 (100%)。
- **單元測試**: 包含 YouTube Client, AI Summarizer, Workers, Queue, Auth 等核心邏輯。
- **測試框架**: Vitest
...
- [摘要客製化功能設計](docs/plans/2026-01-25-summary-preferences-design.md)
